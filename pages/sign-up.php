              ...
              <div class="card-body">
                <form role="form text-left" id="registration-form" action="" method="post">
                  ...
                  <div class="mb-3 pw">
                    ...
                    <div class="mb-3 pw">
                      <input type="password" class="form-control password" name="confirmpassword" id="confirmpassword" placeholder="Password" aria-label="Password" aria-describedby="password-addon">
                      <button class="input-group-button btn btn-light border password_show" id="confirmpassword_show" type="button" onclick="toggle_password()"><i class="fa fa-eye-slash"></i></button>
                    </div>
